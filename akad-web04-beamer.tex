...
\newcommand*{\Title}{Erstellung eines einfachen, vollständigen Online-Shops} %Titel
\subtitle{Modul WEB04} %Untertitel
...
\section{Allgemein}
\begin{frame} %%Eine Folie
  \frametitle{osCommerce} %%Folientitel
...
\begin{frame} %%Eine Folie
  ...
  \begin{block}{Geschäftsmodell}
	  \begin{itemize}
		\item Verkauf von Geschänkartikel
	  \end{itemize}
  \end{block}
\end{frame}
...
\begin{frame} %%Eine Folie
  \frametitle{Realsierung des Onlineshop} %%Folientitel
...
\section{Bewertung}
\begin{frame} %%Eine Folie
  \frametitle{Bewertung} %%Folientitel
